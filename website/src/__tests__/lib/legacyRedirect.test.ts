...
const LEGACY_V1_REDIRECT_CASES = [
  {
  ...
  },
  {
    ...
    inboundUrl:
      "https://policyengine.org/uk/household?basic_rate=16&baseline_basic_rate=20",
    expectedRedirectUrl:
...
const ALREADY_LEGACY_URL_CASES = [
  {
