...
const usUseCases: UseCase[] = [
  {
    ...
    terminal: [
      {
        type: "prompt",
        text: "What if we raised the standard deduction to $20,000?",
      },
      {
        type: "output",
      ...
      {
        type: "success",
        text: "Cost: $80B \u00b7 Winners: 62% \u00b7 Gini: -0.001",
      },
    ],
  },
  {
    ...
    terminal: [
      ...
      {
        type: "success",
        text: "3+ kids: $6,660 (2020) \u2192 $8,231 (2026)",
      },
    ],
  },
  {
    ...
    terminal: [
      ...
      {
        type: "success",
        text: "Net change: +$1,280/yr (+$107/mo)",
      },
    ],
  },
  {
    ...
    terminal: [
      {
        type: "prompt",
        text: "Build a dashboard comparing flat tax rates",
      },
  ...
  },
  {
    ...
    terminal: [
      {
        type: "prompt",
        text: "Write a brief on eliminating the SALT cap",
      },
      {
        type: "output",
        text: "Cost: $69B \u00b7 98% goes to top decile",
      },
      {
        type: "success",
        text: "\u2713 salt_cap_brief.md written with 3 charts",
      },
    ],
  },
  {
    ...
    terminal: [
      {
        type: "prompt",
        text: "Map the SALT cap repeal across all 435 districts",
      },
      { type: "output", text: "Loading district-level microdata..." },
      {
        type: "success",
        text: "\u2713 435 districts analyzed \u2192 choropleth ready",
      },
    ],
  },
];
...
const ukUseCases: UseCase[] = [
  {
    ...
    terminal: [
      {
        type: "prompt",
        text: "What if we raised the personal allowance to \u00a313,500?",
      },
      {
        type: "output",
        text: "Running microsimulation on Family Resources Survey...",
      },
      {
        type: "success",
        text: "Cost: \u00a38B \u00b7 Winners: 54% \u00b7 Gini: -0.001",
      },
    ],
  },
  {
    ...
    terminal: [
      {
        type: "prompt",
        text: "How has the Universal Credit standard allowance changed?",
      },
      {
        type: "output",
        text: "Reading gov.dwp.universal_credit.standard_allowance...",
      },
      {
        type: "success",
        text: "Single 25+: \u00a3318/mo (2015) \u2192 \u00a3400/mo (2025)",
      },
    ],
  },
  {
    ...
    terminal: [
      ...
      {
        type: "output",
        text: "Child Benefit: \u00a32,251 \u2192 \u00a33,120/yr",
      },
      {
        type: "success",
        text: "Net change: +\u00a3869/yr (+\u00a372/mo)",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    terminal: [
      {
        type: "prompt",
        text: "Write a brief on abolishing the two-child limit",
      },
      {
        type: "output",
        text: "Cost: \u00a32.3B \u00b7 90% goes to bottom 3 deciles",
      },
      {
        type: "success",
        text: "\u2713 two_child_limit_brief.md written with 3 charts",
      },
    ],
  },
  {
    ...
    terminal: [
      {
        type: "prompt",
        text: "Map the two-child limit repeal across all 650 constituencies",
      },
      { type: "output", text: "Loading constituency-level microdata..." },
      {
        type: "success",
        text: "\u2713 650 constituencies analyzed \u2192 choropleth ready",
      },
    ],
  },
];
...
const SECTION_PX: React.CSSProperties = {
  paddingLeft: "6.125%",
  paddingRight: "6.125%",
};
...
export default function ClaudePluginClient({
  countryId,
}: {
  countryId: string;
}) {
      ...
      >
        <div style={CONTAINER}>
          ...
          >
            ...
            <FadeInSection
              delay={200}
              style={{ flex: "1 1 400px", maxWidth: 560, width: "100%" }}
            >
              <div
                style={{
                  backgroundColor: TERM_BG,
                  ...
                  lineHeight: 2,
                  boxShadow:
                    "0 24px 80px -12px rgba(0,0,0,0.18), 0 0 0 1px rgba(255,255,255,0.04) inset",
                  position: "relative",
                  overflow: "hidden",
                }}
              >
        ...
        <div style={CONTAINER}>
          ...
          <FadeInSection delay={100}>
            ...
            <div style={{ maxWidth: 800 }}>
              ...
              >
                From our June 2025 launch video &middot;{" "}
                <a
