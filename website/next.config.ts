  ...
  async rewrites() {
    return {
      ...
      beforeFiles: [
        ...
        {
          source: "/us/watca/:path*",
          destination:
            "https://working-americans-tax-cut-act-one.vercel.app/us/watca/:path*",
        },
        // Keep Your Pay Act (Vercel)
        {
          source: "/us/keep-your-pay-act",
          destination:
            "https://keep-your-pay-act.vercel.app/us/keep-your-pay-act",
        },
        {
          source: "/us/keep-your-pay-act/:path*",
          destination:
            "https://keep-your-pay-act.vercel.app/us/keep-your-pay-act/:path*",
        },
        ...
        },
        {
          ...
          destination:
            "https://oregon-kicker-refund.vercel.app/us/oregon-kicker-refund/:path*",
        },
