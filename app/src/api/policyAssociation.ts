/**
 * User Policy Associations Store
 *
 * MIGRATION NOTE: When API v2 alpha adds user-policy-association endpoints,
 ...
 *
 * Key migration steps:
 * 1. Create a new v2/userPolicyAssociations.ts module with:
 ...
 * 2. Update ApiPolicyStore to delegate to the v2 API functions
 * 3. Add delete method to UserPolicyStore interface
