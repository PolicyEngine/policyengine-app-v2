...
import { buildPovertyByGenderCsv } from './PovertyImpactByGenderSubPage';
...
export default function DeepPovertyImpactByGenderSubPage({
  output,
  ...
  return (
    <ChartContainer
      ...
      csvData={() => buildPovertyByGenderCsv(output, true)}
    >
      <Stack gap="sm">
