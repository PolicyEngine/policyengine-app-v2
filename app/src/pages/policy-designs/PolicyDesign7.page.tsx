 ...
 * with left-hand tabs to switch between Current Law, Baseline, and Reform policies.
 */
...
export default function PolicyDesign7Page() {
        ...
        <Box>
          ...
          <Group justify="space-between" align="flex-start" mb={spacing.xs}>
            <Group gap={spacing.xs} align="center">
              ...
              >
                Policy Design 7: Borderless List with Left Tabs
              </Title>
              ...
              >
                ...
                <Box mt={spacing.lg}>
                  <Text size="xs" c={colors.text.secondary} style={{ fontStyle: 'italic' }}>
                    Tab background uses teal-gray blend (#F0FCFB)
                  </Text>
                </Box>
              </Box>
