...
/**
 * Policy Design 6: List format with separate ribbon tabs
 *
 * This design shows parameters in a list format with separate ribbon-level tabs
 * for Current Law, Baseline, and Reform policies instead of a single Policy tab.
 */
...
export default function PolicyDesign6Page() {
        ...
        <Box>
          ...
          <Group justify="space-between" align="flex-start" mb={spacing.xs}>
            <Group gap={spacing.xs} align="center">
              ...
              >
                Policy Design 6: List with Ribbon Tabs
              </Title>
