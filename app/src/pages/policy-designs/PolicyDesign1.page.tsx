...
/**
 * Policy Design 1: Separate left-hand tabs for Baseline and Reform
 *
 * This design shows the "Policy" tab with a nested left-hand navigation
 * that allows switching between Baseline and Reform policies.
 */
...
export default function PolicyDesign1Page() {
  const navigate = useNavigate();
  const [activePolicyTab, setActivePolicyTab] = useState<'baseline' | 'reform'>('baseline');
    ...
    <Container size="xl" px={spacing.xl}>
      <Stack gap={spacing.xl}>
        ...
        <Box>
          ...
          <Group justify="space-between" align="flex-start" mb={spacing.xs}>
            <Group gap={spacing.xs} align="center">
              ...
              >
                Policy Design 1: Left-Hand Tabs
              </Title>
        ...
        >
          ...
          {/* Tab Content - Split Layout for Policy Tab */}
          <Box pt={spacing.xl}>
