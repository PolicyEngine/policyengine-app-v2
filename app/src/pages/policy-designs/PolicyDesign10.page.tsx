...
/**
 * Policy Design 10: Ultra-minimal list with separate ribbon tabs
 *
 ...
 * - Separate ribbon tabs for each policy
 */
...
export default function PolicyDesign10Page() {
        ...
        <Box>
          ...
          <Group justify="space-between" align="flex-start" mb={spacing.xs}>
            <Group gap={spacing.xs} align="center">
              ...
              >
                Policy Design 10: Ultra-Minimal List with Ribbon Tabs
              </Title>
