...
export default function ClaudePluginsPage() {
  ...
  return (
    <StaticPageLayout title="PolicyEngine AI Skills">
      {/* ━━━ HERO ━━━ */}
      <div
        style={{
          paddingTop: 80,
          ...
          >
            ...
            <div style={{ flex: '1 1 400px', maxWidth: 500 }}>
              ...
              <FadeInSection delay={160}>
                ...
                >
                  Use the Claude wrapper in Claude Code or install the source skills repo in Codex.
                  Run microsimulations, model reforms, analyze distributional impacts, and build
                  dashboards from your terminal.
                </p>
              </FadeInSection>
            ...
            <FadeInSection delay={200} style={{ flex: '1 1 400px', maxWidth: 560, width: '100%' }}>
              ...
              >
                ...
                />
                <TerminalLine type="prompt" text="/plugin install complete@policyengine-claude" />
      ...
      >
        <div style={CONTAINER}>
          ...
          <FadeInSection delay={100}>
            ...
            >
              Watch how the PolicyEngine AI workflow examines the impact of TANF on a household in
              LA County — from a plain-English prompt to a full household-level analysis.
            </p>
      ...
      >
        <div style={CONTAINER}>
          <FadeInSection>
            ...
            >
              The analysis-tools Claude bundle turns Claude into a microsimulation analyst, and the
              same underlying skills can be installed in Codex. Point either setup at any tax or
              benefit reform and it runs full population analysis using PolicyEngine&apos;s weighted
              survey data.
            </p>
          </FadeInSection>
