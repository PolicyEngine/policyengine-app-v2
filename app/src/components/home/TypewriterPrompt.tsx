...
const UK_PROMPTS: PromptData[] = [
  ...
  { text: 'how reducing the UC taper rate to 45% helps workers', winnerPct: 0.25, loserPct: 0 },
...
const US_PROMPTS: PromptData[] = [
  ...
  { text: 'the cost of making the standard deduction universal', winnerPct: 0.45, loserPct: 0.1 },
  ...
  { text: 'how increasing SSI benefits affects poverty', winnerPct: 0.15, loserPct: 0 },
  {
