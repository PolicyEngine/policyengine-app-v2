 ...
 *
 * For household simulations, the output field stores the calculated results.
 * For geography simulations, outputs are stored in Report (economy calculations).
 */
export interface Simulation {
  ...
  output?: Household | null; // Calculation output for household simulations only
}
