...
For building software, they announced the beta launch of what is now the [policyengine-claude Claude wrapper](https://github.com/PolicyEngine/policyengine-claude), backed by the shared [policyengine-skills repository](https://github.com/PolicyEngine/policyengine-skills). It provides custom commands, specialised agents, and domain knowledge for PolicyEngine development. They demonstrated a scientific approach to rules-as-code automation: creating golden pull requests with manually verified code, using AI to generate implementations from policy descriptions, then iteratively adjusting prompts to maximise alignment between AI-produced and golden code.
