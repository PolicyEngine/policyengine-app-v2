...
All state income tax parameters are maintained in the [policyengine-us](https://github.com/PolicyEngine/policyengine-us) repository. Each state's parameters are organized by tax year, allowing for accurate historical analysis as well as current-year calculations.

We welcome contributions and feedback from the community. If you notice any discrepancies or have suggestions for improvements, please open an issue on our [GitHub repository](https://github.com/PolicyEngine/policyengine-us/issues) or contact us at [hello@policyengine.org](mailto:hello@policyengine.org).
