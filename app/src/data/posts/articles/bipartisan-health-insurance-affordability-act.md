A bipartisan group of senators has introduced the [Bipartisan Health Insurance Affordability Act](https://www.congress.gov/bill/119th-congress/senate-bill/976) (S. 976), which would extend and modify Affordable Care Act premium tax credits. In this report, we use the PolicyEngine ACA microsimulation model to analyze how this bill would affect representative households compared to current law and a full IRA extension.
