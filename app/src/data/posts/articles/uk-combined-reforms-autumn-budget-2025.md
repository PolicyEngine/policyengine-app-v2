...
The combined reforms reduce income inequality in all years analysed. The Gini coefficient falls by 0.7-0.8% across the forecast period. The reduction is largest in 2029-30 and 2030-31 when the salary sacrifice cap takes effect.
...
The combined reforms reduce child poverty throughout the forecast period. The child poverty rate (after housing costs) falls by 3.4 to 3.8 percentage points across all years, a reduction of 11.8-13.1%. Overall poverty (BHC) falls by 0.7 to 0.8 percentage points, while working-age adult poverty falls by 0.3 to 0.4 percentage points. Pensioner poverty increases slightly, by up to 0.1 percentage points by 2030-31.

## Conclusion

PolicyEngine estimates that the combined Autumn Budget 2025 reforms cost £6.6 billion in 2026-27, transitioning to raising £12.4 billion by 2030-31. The bottom four income deciles gain on average in every year, while the top six deciles experience losses by 2030-31. The reforms reduce income inequality by 0.7-0.8% as measured by the Gini coefficient and reduce the overall poverty rate by 0.7-0.8 percentage points.

The child poverty rate (after housing costs) falls by 3.4-3.8 percentage points. The salary sacrifice cap, extended threshold freeze, and investment income tax increases contribute to the revenue raised from higher earners.
