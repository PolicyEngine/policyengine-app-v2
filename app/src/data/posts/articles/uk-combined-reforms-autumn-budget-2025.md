...
The Autumn Budget 2025 includes nine key reforms that we model in this analysis. Some measures increase household incomes (such as repealing the two-child limit and freezing fuel duty), while others reduce incomes through higher taxes (such as increased rates on dividends, savings, and property income). This combined analysis captures how these policies interact and their net effect on UK households.
...
Our analysis makes the following key assumptions:

- **Behavioural responses**: We [INCLUDE/EXCLUDE] behavioural responses [DESCRIPTION IF INCLUDED]
- **Employer NIC incidence**: [DESCRIPTION OF HOW EMPLOYER NIC CHANGES ARE MODELLED]
- **Baseline**: We compare against current law as of [DATE], including scheduled uprating
- **Data limitations**: FRS data may underreport savings income and property income; student loan data is based on [DESCRIPTION]

### Data

This analysis uses PolicyEngine's UK microsimulation model, which draws on:

- **Survey data**: Family Resources Survey (FRS) [YEAR], enhanced with administrative data
- **Calibration**: Weights are calibrated to match ONS population projections and HMRC tax statistics
- **Time period**: We model the combined reforms for fiscal years 2026-27 through 2029-30
...
Figure 1 shows the relative change in household income by income decile from the combined reforms.

**Figure 1: Relative change in household income by income decile**

[PLOTLY CHART PLACEHOLDER - DECILE BAR CHART]
...
[INTERPRETATION - WHAT PERCENTAGE GAIN/LOSE AND BY HOW MUCH, HOW THIS COMPARES TO INDIVIDUAL POLICIES]
...
[INTERPRETATION - GEOGRAPHIC PATTERNS, TOP/BOTTOM CONSTITUENCIES, HOW DIFFERENT REGIONS ARE AFFECTED]

### Inequality impact

Table 2 shows the impact of the combined reforms on income inequality as measured by the Gini coefficient.
...
[INTERPRETATION - WHETHER COMBINED REFORMS INCREASE OR DECREASE INEQUALITY, AND WHY]

### Poverty impact

Table 3 shows the impact of the combined reforms on poverty rates.

**Table 3: Change in poverty rates**

| Measure                      | 2026-27 | 2027-28 | 2028-29 | 2029-30 |
| ---------------------------- | ------- | ------- | ------- | ------- |
| Overall poverty (BHC)        | [X.XX]% | [X.XX]% | [X.XX]% | [X.XX]% |
| Overall poverty (AHC)        | [X.XX]% | [X.XX]% | [X.XX]% | [X.XX]% |
| Child poverty (BHC)          | [X.XX]% | [X.XX]% | [X.XX]% | [X.XX]% |
| Child poverty (AHC)          | [X.XX]% | [X.XX]% | [X.XX]% | [X.XX]% |
| Working-age poverty (BHC)    | [X.XX]% | [X.XX]% | [X.XX]% | [X.XX]% |
| Pensioner poverty (BHC)      | [X.XX]% | [X.XX]% | [X.XX]% | [X.XX]% |

[INTERPRETATION - HOW REFORMS AFFECT DIFFERENT DEMOGRAPHIC GROUPS, NOTING THAT TWO-CHILD LIMIT REPEAL DRIVES CHILD POVERTY REDUCTIONS]

## Conclusion

PolicyEngine estimates that the combined Autumn Budget 2025 reforms [RAISE/COST] £[X.X] billion in [YEAR]. [SUMMARY OF KEY DISTRIBUTIONAL FINDINGS - WHICH GROUPS GAIN/LOSE]. The reforms [INCREASE/REDUCE] income inequality by [X.XX]% as measured by the Gini index and [INCREASE/REDUCE] the overall poverty rate by [X.XX]%.
...
*Analysis by PolicyEngine. [Data and code available on GitHub](LINK_TO_REPO_OR_GIST).*
