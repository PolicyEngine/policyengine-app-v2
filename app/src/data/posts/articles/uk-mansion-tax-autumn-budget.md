...
![](/images/posts/uk-mansion-tax/mansion_tax_map_1m.png)
...
![](/images/posts/uk-mansion-tax/mansion_tax_map_2m.png)
...
The impact is concentrated in London and the South East. Most constituencies outside these areas would see minimal impact.
...
A mansion tax would primarily affect constituencies in London and the South East. Under a £1.5 million threshold, 15,300 properties would be affected in 2026-27, falling to 8,500 under a £2 million threshold. Cities of London and Westminster would be most affected under both scenarios.

Explore the [PolicyEngine UK webapp](https://policyengine.org/uk) to model tax reforms.
