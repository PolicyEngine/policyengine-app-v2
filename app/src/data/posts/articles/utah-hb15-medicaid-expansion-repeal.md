...
Let's examine how HB 15 affects different household types across the income spectrum.

**Single adult**: At $12,000/year (75% FPL), a single adult currently receives ~$8,000 in annual Medicaid benefits. Under HB 15, they would lose this coverage entirely and fall into the coverage gap—earning too little for ACA subsidies but no longer qualifying for Medicaid.
...
![Utah HB 15: Health Benefits by Household Income](/assets/posts/utah-hb15-benefits-by-household.png)

The chart above shows how benefits change across income levels for both household types. Solid lines represent current law (baseline), while dotted lines show the reform scenario.
