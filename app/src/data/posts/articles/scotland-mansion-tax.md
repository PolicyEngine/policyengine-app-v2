...
**Revenue allocation**: We allocate the Scottish Government's £16m estimate proportionally by each constituency's share of estimated sales. Unlike the [UK mansion tax analysis](https://github.com/PolicyEngine/uk-mansion-tax) where OBR announced specific surcharge rates (£2,500-£7,500/year), Scotland has not yet set Band I and J rates, so we cannot independently calculate revenue.

**Limitations**: Constituency-level figures are modelled estimates. Population-based weighting assumes £1m+ sales are distributed similarly to population within each council area. Revenue figures allocate the government's £16m projection—actual rates await announcement.
