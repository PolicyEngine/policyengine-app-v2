...
| Rank | Constituency                     | Projected sales | Revenue | Share |
| :--: | :------------------------------- | :---: | :-----: | :---: |
...
Of the 553 constituencies we project will have sales subject to the surcharge in 2028:
...
| Band (2028 prices) | Sales | Share | Revenue contribution |
| :----------------- | :---: | :---: | :------------------: |
...
**Uprating methodology:** The policy takes effect in April 2028. We uprate 2024 sale prices to 2028 using OBR house price forecasts (10.7% cumulative growth). We also uprate the thresholds from their 2026 base values using OBR CPI forecasts (4.5% cumulative from 2026 to 2028). This means the £2m threshold becomes approximately £2.09m in 2028 prices, and the band boundaries are similarly adjusted. This approach captures the properties that would actually be subject to the surcharge when it comes into effect.
