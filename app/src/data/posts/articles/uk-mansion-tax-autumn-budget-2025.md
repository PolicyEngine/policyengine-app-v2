...
Of the 553 constituencies with 2024 sales exceeding £2 million (uprated to 2026 prices):
...
**Why uprate to 2026?** The policy defines its thresholds in 2026 prices: a property is subject to surcharge if its value exceeds £2m in 2026 prices. We uprate 2024 sale prices by OBR house price forecasts (5.5% cumulative) to express them in 2026 terms and compare against this fixed threshold. The thresholds themselves are uprated by CPI from 2028 onwards, but the £2m starting point is anchored to 2026.
