...
By income decile, restoring the two-child limit would cause the largest income losses for the second decile. In relative terms, the second decile loses 1.38% of household income in 2029-30. In absolute terms, this amounts to £470 per year. Figure 1 shows both relative and absolute changes by decile, with a toggle to switch between views and year buttons to compare 2029-30 and 2030-31.

**Figure 1: Change in household income by income decile**

<iframe src="/assets/posts/uk-two-child-limit-reintroduction/distributional-impact.html" width="100%" height="530" frameborder="0"></iframe>

The losses decline for higher deciles, with deciles 8 to 10 seeing no change. By 2030-31, the second decile's loss increases to £482 per year.
...
| ------- | ------- | -------- | ------ | ----------- |
| 2029-30 | BHC     | 12.79%   | 15.13% | +2.35       |
| 2029-30 | AHC     | 22.30%   | 25.06% | +2.76       |
...
| Year    | Measure | Baseline | Reform | Change (pp) |
| ------- | ------- | -------- | ------ | ----------- |
| 2029-30 | BHC     | 8.86%    | 9.52%  | +0.66       |
| 2029-30 | AHC     | 13.86%   | 14.71% | +0.85       |
| 2030-31 | BHC     | 9.01%    | 9.67%  | +0.66       |
| 2030-31 | AHC     | 13.97%   | 15.26% | +1.28       |

In 2029-30, absolute child poverty (BHC) would increase by 2.35 percentage points, from 12.79% to 15.13%. After housing costs, child poverty would increase by 2.76 percentage points, from 22.30% to 25.06%. By 2030-31, the after housing costs child poverty increase grows to 4.21 percentage points.
...
<iframe src="/assets/posts/uk-two-child-limit-reintroduction/constituency_map.html" width="100%" height="600" frameborder="0"></iframe>
