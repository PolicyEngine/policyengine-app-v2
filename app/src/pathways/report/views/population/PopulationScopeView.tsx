...
type ScopeType = 'national' | 'country' | 'constituency' | 'state' | 'congressional_district' | 'household';
...
export default function PopulationScopeView({
  ...
  function submissionHandler() {
    ...
    const needsRegion = ['state', 'congressional_district', 'country', 'constituency'].includes(scope);
  ...
  const formInputs = (
    <Stack>
      {countryId === 'uk' ? (
        ...
        <USGeographicOptions
          scope={scope as 'national' | 'state' | 'congressional_district' | 'household'}
          selectedRegion={selectedRegion}
