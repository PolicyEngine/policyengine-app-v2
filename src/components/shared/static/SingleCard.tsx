...
export function SingleCard({
  ...
  return (
    <Card shadow="sm" padding={spacing["3xl"]} radius={spacing.radius.lg} withBorder onClick={onClick}
      style={{ cursor: onClick ? "pointer" : "default", backgroundColor, border: hovered
          ? `solid ${colors.black}`
